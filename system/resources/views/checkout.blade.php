        ...
        <div class="row justify-content-center">
          <div class="col-xl-7 ftco-animate">
						<form action="#" class="billing-form">
							<h3 class="mb-4 billing-heading">Data Pelanggan</h3>
		            ...
		            <div class="col-md-12">
		            	<div class="form-group">
		                  ...
		                  <select name="" id="" class="form-control">
		                    ...
		                    <option value="">Singkawang</option>
		                    <option value="">Ketapang</option>
		                    <option value="">Mempawah</option>
		                    <option value="">Sanggau</option>
	          		...
	          		<div class="cart-detail p-3 p-md-4">
	          			<h3 class="billing-heading mb-4">Pembayaran</h3>
									...
									<div class="form-group">
										<div class="col-md-12">
											<div class="radio">
											   <label><input type="radio" name="optradio" class="mr-2"> Bayar Ditempat</label>
											</div>
										</div>
									</div>
									...
									<p><a href="cart"class="btn btn-primary py-3 px-4">Place an order</a></p>
								</div>
	          	</div>
	          </div>
          </div> <!-- .col-md-8 -->

	    				...
	    				<table class="table">
						    ...
						    <tbody>
						      <tr class="text-center">
						        ...
						        <td class="image-prod"><div class="img" style="background-image:url(public/assets/images/bayam.png)"></div></td>
    		...
    		<div class="row justify-content-end">
    			<div class="col-lg-4 mt-5 cart-wrap ftco-animate">
	              ...
	              <div class="form-group">
    				...
    				<p><a href="checkout" class="btn btn-primary py-3 px-4">Nama Kupon</a></p>
    			</div>
    			...
    			<div class="col-lg-4 mt-5 cart-wrap ftco-animate">
    				...
    				<p><a href="checkout" class="btn btn-primary py-3 px-4">Checkout</a></p>
    			</div>
    		</div>
			</div>
		</section>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart color-danger" aria-hidden="true"></i> by <a href="https://cpasline.com" target="_blank">Pasline</a>

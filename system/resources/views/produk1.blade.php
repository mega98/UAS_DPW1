      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <p class="breadcrumbs"><span class="mr-2"><a href="home">Home</a></span> <span class="mr-2"><a href="index.html">Product</a></span> <span>Product Single</span></p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 mb-5 ftco-animate">
            <a href="public/assets/images/product-1.jpg" class="image-popup"><img src="public/assets/images/bayam.png" class="img-fluid" alt="Colorlib Template"></a>
          </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-3 pb-3">
          <div class="col-md-12 heading-section text-center ftco-animate">
            ...
            <p>Ditoko Banyak Berbagai macam Produk yang Segar </p>
          </div>
        </div>      
      </div>
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-lg-3 ftco-animate">
            <div class="product">
              <a href="produk1" class="img-prod"><img class="img-fluid" src="public/assets/images/product-1.jpg" alt="Colorlib Template">
              ...
              <div class="text py-3 pb-4 px-3 text-center">
                ...
                <div class="d-flex">
                  <div class="pricing">
                    <p class="price"><span class="mr-2 price-dc">Rp 120.000</span><span class="price-sale">Rp 80.000</span></p>
                  </div>
                </div>
                <div class="bottom-area d-flex px-3">
                  <div class="m-auto d-flex">
                    <a href="home" class="add-to-cart d-flex justify-content-center align-items-center text-center">
                      <span><i class="ion-ios-menu"></i></span>
                    </a>
                    <a href="produk1" class="buy-now d-flex justify-content-center align-items-center mx-1">
          ...
          <div class="col-md-6 col-lg-3 ftco-animate">
            <div class="product">
              <a href="produk1" class="img-prod"><img class="img-fluid" src="public/assets/images/product-2.jpg" alt="Colorlib Template">
                <div class="overlay"></div>
              </a>
              <div class="text py-3 pb-4 px-3 text-center">
          ...
          <div class="col-md-6 col-lg-3 ftco-animate">
            <div class="product">
              <a href="produk1" class="img-prod"><img class="img-fluid" src="public/assets/images/product-3.jpg" alt="Colorlib Template">
                <div class="overlay"></div>
              </a>
              <div class="text py-3 pb-4 px-3 text-center">
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-23 mb-3">
                <ul>
                  <li><span class="icon icon-map-marker"></span><span class="text">Ketapang, Kalbar</span></li>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
              Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart color-danger" aria-hidden="true"></i> by <a href="https://pasline.com" target="_blank">Pasline</a>
